cd ../../
python unsupervised/preprocessors/prepare_full_data_UCP.py \
...
--changepoint_file /home/dhgbao/Research_Monash/dataset/ccu-data/CCU_COMBINED_ANNOTATED_VIDEO/csv/changepoints_preprocessed.csv